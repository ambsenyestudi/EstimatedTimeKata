...
namespace EstimatedTime.Acceptance.Test
{
    public class EstimatedDurationServiceShould
    {
        ...
        public void ProcessDuration()
        {
            ...
            var originalInput = "Walk on the beach at sunset at beautyful Platja d'es Capellans, Can Pcafort, up to the hut bar for some cocktails. Estimated duration 1 hours and 1 minutes.";
